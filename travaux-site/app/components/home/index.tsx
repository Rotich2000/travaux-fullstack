    ...
    <div id="home">
      ...
      >
        <div className="w-full h-[90vh] relative">
          <Image src={image1} alt="logo" fill className="object-cover" quality={100}/>
          <div
        ...
        <div className="w-full h-[90vh] relative">
          <Image src={image2} alt="logo" fill className="object-cover" quality={100} />
          <div
        ...
        <div className="w-full h-[90vh] relative">
          <Image src={image3} alt="logo" fill className="object-cover" quality={100} />
          <div
            className="absolute text-white top-[46%] md:left-[10%] p-[20px]
        ...
        <div className="w-full h-[90vh] relative">
          <Image src={image4} alt="logo" fill className="object-cover" quality={100} />
          <div
            className="absolute text-white top-[46%] md:left-[10%] p-[20px]
           bg-gray-400 rounded backdrop-filter backdrop-blur-md bg-opacity-10"
          >
